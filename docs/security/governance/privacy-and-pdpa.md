...
| Customer phone | Registration contact metadata, customer profile correction, and PayUp lookup | Singapore phone format only; optional for preserved legacy rows; profile changes require TOTP; do not use as an authenticator or log raw phone values |
