...
| Manual recovery requests | Preserve pending, under-review, approved, denied, expired, cancelled, and completed request metadata needed to reconstruct root-admin review and direct execution decisions. | Case-reference summary, final state, reviewer/action record, notification/audit evidence without raw recovery material |
