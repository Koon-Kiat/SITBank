...
| Design | Partially implemented | `docs/security/access-control.md`, `docs/security/cryptography-and-authentication.md` | `tests/test_route_inventory_security.py`, `tests/test_admin_route_inventory_security.py` | Access-control and crypto architecture docs | Threat model and design risk register are open |
