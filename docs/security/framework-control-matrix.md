...
| Operations | Partially implemented | `docs/OPERATIONS.md`, `ops/cloudflare/provision-staging-access`, `docs/security/security-gap-register.md` | `tests/test_deployment.py`, `tests/test_cloudflare_access_automation.py` | Alert timer, backup tooling, deployment notes, and repository-managed Cloudflare Access verification exist | Live EC2 SSH/UFW, IdP, Tailscale, and cloud state still need operator evidence |
...
| Control area | Status | Relevant files | Relevant tests | Current evidence | Remaining gaps / follow-up |
| --- | --- | --- | --- | --- | --- |
| Account and access management | Partially implemented | `app/admin/services.py`, `ops/cloudflare/provision-staging-access`, `docs/security/admin-and-staging-zero-trust-access.md` | `tests/test_admin_staff_invites.py`, `tests/test_cloudflare_access_automation.py`, `tests/test_zero_trust_access_boundary.py` | Staff invites, root-admin TOTP, admin isolation, narrow Access policy/DNS automation, and live boundary verification | Live IdP membership and Tailscale state need operator verification |
...
| Control area | Status | Relevant files | Relevant tests | Current evidence | Remaining gaps / follow-up |
| --- | --- | --- | --- | --- | --- |
| Access control and MFA | Partially implemented | `docs/security/admin-and-staging-zero-trust-access.md`, `ops/cloudflare/provision-staging-access`, `app/admin/services.py` | `tests/test_admin_staff_invites.py`, `tests/test_cloudflare_access_automation.py`, `tests/test_zero_trust_access_boundary.py` | Admin TOTP, staff invite lifecycle, and fail-closed Cloudflare Access staging automation | Live IdP and Tailscale membership require operator verification |
